Summary: EMBOSS:VIENNA Applications
Name: VIENNA
Version: 1.7.2
Release: 5.%{distro}
license: GPL
...
BuildPrereq: EMBOSS-devel > 5.0.0
BuildRoot: %{_tmppath}/%{name}-buildroot
Prereq: EMBOSS > 5.0.0

%description
This is Version 1.7.2 of the Vienna RNA Package integrated with EMBOSS
...
%{_bindir}/*
%{_libdir}/libviennarna.*
%{_datadir}/EMBOSS/acd/*
%{_datadir}/EMBOSS/doc/html/embassy/vienna/*
%{_datadir}/EMBOSS/doc/programs/text/*

%changelog
* Mon Jan 11 2010 Sean Collins <contact@seanmcollins.com> 1.6-5
- Rebuilt for EMBOSS 6.1.0

* Mon Jul 23 2007 Ryan Golhar <golharam@umdnj.edu> 1.6-4
- Rebuilt for EMBOSS 5.0.0

* Wed Mar  7 2007 Ryan Golhar <golharam@umdnj.edu> 1.6-3
- Rebuilt for EMBOSS 4.1.0

* Thu Nov  2 2006 Ryan Golhar <golharam@umdnj.edu> 1.6-2
- Changed the application to Applications/Bioinformatics

* Fri Aug 11 2006 Ryan Golhar <golharam@umdnj.edu> 1.6-1
