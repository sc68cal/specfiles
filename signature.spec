Summary: EMBOSS:SIGNATURE Applications
Name: SIGNATURE
Version: 0.1.0
Release: 7.%{distro}
license: GPL
...
%description
The SIGNATURE programs were developed by Jon Ison and colleagues at HGMP for their protein domain research. They are included as an EMBASSY package as a work in progress.
...
%{_bindir}/*
%{_datadir}/EMBOSS/acd/*
%{_datadir}/EMBOSS/doc/html/embassy/signature/*
