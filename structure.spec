Summary: EMBOSS:STRUCTURE Applications
Name: STRUCTURE
Version: 0.1.0
Release: 7.%{distro}
license: GPL
...
%description
The STRUCTURE programs were developed by Jon Ison and colleagues at HGMP for their protein domain research. They are included as an EMBASSY package as a work in progress.
...
%{_bindir}/*
%{_datadir}/EMBOSS/acd/*
%{_datadir}/EMBOSS/doc/html/embassy/structure/*
