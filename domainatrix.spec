Summary: EMBOSS:DOMAINATRIX Applications
Name: DOMAINATRIX
Version: 0.1.0
Release: 7.%{distro}
license: GPL
...
%description
The DOMAINATRIX programs were developed by Jon Ison and colleagues at HGMP for 
...
%{_bindir}/*
%{_datadir}/EMBOSS/acd/*
%{_datadir}/EMBOSS/doc/html/embassy/domainatrix/*
...
- Changed the application group to Applications/Bioinformatics
...
- Changed binary location from /usr/local/bin to /usr/bin
